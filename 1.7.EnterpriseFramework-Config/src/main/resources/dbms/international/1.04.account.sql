...
create table system_accounts (
  ...
  region_id              int                  default 0, --所属组织
  theme                  varchar2(16)         null        , --缺省样式
  language               varchar2(8)          default 'zh_CN', --缺省语言
  ...
  last_name              varchar2(16)         null        , --姓
  firt_name              varchar2(16)         null        , --名
...
comment on column system_accounts.display is '真实姓名';
...
comment on column system_accounts.region_id is '所属组织';
...
comment on column system_accounts.last_name is '姓';
comment on column system_accounts.firt_name is '名';
