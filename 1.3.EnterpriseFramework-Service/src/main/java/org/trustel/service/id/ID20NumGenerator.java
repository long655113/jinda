...
/**
 * <pre>
 * 类 名：ID20NumGenerator.java
 * 作 者：hujh
 * 日 期：2012-10-23
 * 描 述：20位数值型id生成器，12位时间序列+3位随机数+5位数据库序列值
 * </pre>
 */
public class ID20NumGenerator implements IdentifierGenerator {
	...
	/**
	 * 获取时间序列(12位)：两位年+两位月+两位日+两位小时+两位分钟+两位秒
	 * @return
	 */
