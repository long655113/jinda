...
public class QueryBuilder extends ConditionFactory implements IQuery {
	...
	public void addBuilder(IQuery builder, String fieldName,
		...
		if (tmp.equals(""))
			return;
		//此处 子查询 sql 语句,会出现两次"select 字段名"
	...
	public void addBuilder(IQuery builder, String fieldName, int action) {
		addBuilder(builder,fieldName,"", action);
	}
	...
	public void appendNoAnd(String hql){
		append(hql,false);
	}
